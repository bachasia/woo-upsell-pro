...
trait WUP_Settings_Schema {
	...
	private function schema_bundle(): array {
		return [
			...
			[ 'id' => 'wup_upsell_bundle_add_action_label',     'name' => 'Add Bundle Button Label',  'type' => 'text',     'default' => 'Add All To Cart', 'tab' => 'wup-bundle' ],
	...
	private function schema_bmsm(): array {
		return [
			...
			[ 'id' => 'wup_bmsm_position',                      'name' => 'Position Hook',           'type' => 'select',   'default' => 'woocommerce_single_product_summary', 'tab' => 'wup-bmsm',
				'options' => [ 'woocommerce_single_product_summary' => 'Product Summary', 'woocommerce_after_single_product_summary' => 'After Summary' ] ],
			...
			[ 'id' => 'wup_bmsm_style',                         'name' => 'Display Style',           'type' => 'select',   'default' => 'style1',   'tab' => 'wup-bmsm',
				'options' => [ 'style1' => 'Table (Default)', 'style4' => 'Card Grid' ] ],
